...
function TeacherForm() {
  ...
  // Every time a new schedule is added, it starts with all its fields empty
  ...
  const setScheduleItemValue = useCallback(
    (position: number, field: string, value: string) => {
      // Loop throught the array of schedules
      const updatedScheduleItems = scheduleItems.map((item, index) => {
        // Check if the item's position in the array is the same position of the item that was changed
        if (index === position) {
